					...
					<div id="nav-search">
						<div id="nav-search-wrapper">
							...
							<div id="nav-search-bar">
								<label id="placeholder-text">Search user</label>
								<input type="text" name="search" class="browser-default" id="nav-search-input" length="50" autocomplete="off"> 
							</div>
						</div>
						<div id="nav-search-result" class="z-depth-2">
							<div class="search-list-wrapper">
								<!-- SAMPLE SEARCH RESULT
								<div class="search-list-item">
									<div class="search-list-item-image-wrap">
										<img class="circle" src="../uploads/userimage/user.png">
									</div>
									<div class="search-list-item-description">
										<h4>Binay Kumar Agrawal</h4>
										<p class="grey-text text-darken-1">8908540941<br>bnayagrawal@gmail.com<br>Msc is [2015]</p>
									</div>
									<div class="search-list-item-option">
										<a href="#"><i class='material-icons delete-link grey-text'>more_vert</i></a>
									</div>
								</div>
								-->
							</div>
							...
							<li>
							  <div class="collapsible-header user-heading">
								<span class='badge-users'>
									<span class='badge-text <?php echo $theme; ?>'><?php echo $total_students; ?> USERS</span>
								</span>
								Students
							  </div>
