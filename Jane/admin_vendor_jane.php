...
<nav class="navbar navbar-inverse">
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
		...
		<li class="active"><a href="admin_vendor.php">Vendor</a></li>
      </ul>
...
$select_sql = "SELECT vendor_id, vendor_name, vendor_address, vendor_city, vendor_state, vendor_country FROM `vendor`";
...
echo "<tr>
			...
			<td>{$row['vendor_country']}</td>
			
            <td><a href='admin_delete_vendor.php?myID={$row['vendor_id']}' onclick='return checkDelete()' class='btn btn-danger btn-sm'><span class='glyphicon glyphicon-trash'></span>delete</a></td>
