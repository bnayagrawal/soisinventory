<?php
	...
	$info = mysqli_query($mysqli, "select * from user WHERE user_username='$current_user'");
			...
			<div class="row">
				<div class="col s12 m4 l4 offset-l4 valign-wrapper">
					<div id="settings-panel" class="z-depth-5 white valign">
						<a href="user_component.php" id="sois-heading" class="center-align"> SOIS <span class="pink-text text-darken-1"> INVENTORY </span></a>
						...
						<form class="col s12" id="form-user" action="../database/updateUserInfo.php" method="POST" enctype="multipart/form-data">
							<div class="row">
